...
void setup(void) {
  ...
  Serial.println("hdw_query_account_key_info");
  ret = hdw_query_account_info(0x02);
  Serial.println(ret);
  ret = hdw_query_account_info(0x03);
  Serial.println(ret);

  hdw_generate_next_trx_addr(0x02);
  hdw_generate_next_trx_addr(0x03);

  Serial.println("Query Account Key");
  ret = hdw_query_account_key_info(0x02);
  ret = hdw_query_account_key_info(0x03);
