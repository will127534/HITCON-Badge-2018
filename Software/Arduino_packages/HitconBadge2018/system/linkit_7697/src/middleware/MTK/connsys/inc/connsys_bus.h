...
#define DUPM_N9_QUERY_STATUS_INT (1<<8) /*MTK_SAVE_LOG_AND_CONTEXT_DUMP_ENABLE*/
...
#define D2H_SW_INT_EN_MASK (0xffffff << 9)    /*MTK_SAVE_LOG_AND_CONTEXT_DUMP_ENABLE*/
...
#define WSICR 0x0024
#define NUMP_N9_TRIGGER_INT_SET (1 << 16)    /*MTK_SAVE_LOG_AND_CONTEXT_DUMP_ENABLE*/
#define NUMP_N9_TRIGGER_INT_CLR (1 << 17)    /*MTK_SAVE_LOG_AND_CONTEXT_DUMP_ENABLE*/
...
#define GDMA_CH6_BASE          (DMA_BASE+0x600)
